...
from messenger.shared.signing.types import InitialKeyActivationPolicy, SigningKeyPurpose
...
class SigningKeyRegistry:
    """Database-backed lifecycle policy owned by the key manager."""

    def reconcile(
        self,
        session: Session,
        *,
        provider: KeyDiscoveryProvider,
    ...
    @staticmethod
    def _active_query(*, purpose: SigningKeyPurpose, algorithm: str) -> Select[tuple[SigningKey]]:
